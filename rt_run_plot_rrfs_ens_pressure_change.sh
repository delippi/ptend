...
ssh-keygen \
    -R emcrzdm.ncep.noaa.gov \
    -f /u/donald.e.lippi/.ssh/known_hosts

rsync -a \
    rrfs_ens_pressure_change_*png \
    donald.lippi@emcrzdm.ncep.noaa.gov:/home/www/emc/htdocs/mmb/dlippi/rrfs_a/ptend/
